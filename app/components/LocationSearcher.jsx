    ...
    <div className="mt-5">
      <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="text-white absolute right-2.5 bottom-2.5 bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-cyan-500 dark:hover:bg-cyan-700 dark:focus:ring-cyan-500 transition duration-300"
          >
            Search
          </button>
        </div>
        <div className="text-center">
        <small className="text-gray-500">Region / Location / Country</small>
        </div>
      </form>
